...
const { Fixture, Country, knex } = require("@root/db");
...
router.get("/", async (req, res) => {
  try {
    ...
    var fixtures = await Fixture.findExtendedWithAggregates(date)
...
router.get("/ids", async (req, res) => {
  try {
    var fixtures = await Fixture.findByIdsExtended(req.query.ids);
