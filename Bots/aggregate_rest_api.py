...
from fieldtypes import result_fields
...
def make_aggregate(df, team_id, fixture_id, last_x, team, limit):
    ...
    per_maps = {
        ...
        "scored_o05": ["o05_home_goals", "o05_away_goals_1h"],
...
def lambda_handler(event, context):
    ...
    tasks = []
    for _id in fixture_ids:
        find_fixture_and_aggregate(_id)
    ...
    message = f"Done in {end - begin}"
    print(message, fixture_ids)
    return {
        'statusCode': 200,
